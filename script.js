(function () {
    ...
    function createTextInput() {
        ...
        function storePlayers(numberOfPlayers) {
            ...
            Player.prototype.setTime = function (bestTime, totalTime, numberOfRounds) {
                ...
                this.averageTime = (totalTime / numberOfRounds).toFixed(3);
            };
            var i, players = [];
        ...
        document.getElementById('answer').onclick = function () {
            switch (status) {
                ...
                case 'shape':
                    ...
                    if (reactionTime < bestTime || bestTime === 0) bestTime = reactionTime;
    ...
    function getColor() {
        var colors = ['Green', 'Blue', 'Red', 'Orange', 'Pink', 'Yellow', 'Purple', 'Black', 'Grey', 'Cyan'];
    ...
    function displayResults(players) {
        ...
        for (i = 0; i < players.length; i++) {
            ...
            tr.appendChild(cell);
            cell = document.createElement('td');
            cell.innerHTML = players[i].averageTime;
            tr.appendChild(cell);
            table.appendChild(tr);
        }
    }
